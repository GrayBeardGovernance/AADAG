...
```mermaid
graph TD
    A[Decision: What is AI helping shape?] --> B[Consequence: What if it's wrong?]
    B --> C[Influence: Inform, Recommend, Presume, Decide]
    C --> D[Human Authority: Who owns accountability?]
